    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-cadet-blue rounded-lg shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="bg-green-50 rounded-lg p-4 shadow hover:shadow-md transition-shadow">
                    ...
                    <p class="text-xs text-gray-500"><strong class="font-extrabold text-sm">Período:</strong> 20/05/1111 - 20/07/2025</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-light-coral rounded-lg shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <!-- Novo Card com Período Expirado e Badge -->
                <div class="bg-gray-100 rounded-lg p-4 shadow hover:shadow-md transition-shadow opacity-50">
                    <div class="flex justify-between items-start">
                        <h3 class="text-sm font-semibold text-gray-400">Empresa: Tech Innovate</h3>
                        <span class="bg-gray-300 text-gray-700 text-xs font-medium px-2 py-1 rounded">Expirado</span>
                    </div>
                    <p class="text-xs text-gray-500"><strong class="font-extrabold text-sm text-gray-500">Campanha:</strong> Avaliação de Competências</p>
                    <p class="text-xs text-gray-500"><strong class="font-extrabold text-sm text-gray-500">Título:</strong> Produtividade Individual</p>
                    <p class="text-xs text-gray-400"><strong class="font-extrabold text-sm text-gray-400">Período:</strong> 01/01/2025 - 28/02/2025</p>
                </div>
            </div>
        </div>
    </div>
