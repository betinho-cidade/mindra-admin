...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Novo Funcionário da Empresa - {{$empresa->nome}}</h4>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <h4 class="card-title">Formulário de Cadastro - Funcionário</h4>
            ...
            <form name="create_empresa_funcionario" method="POST" action="{{route('empresa_funcionario.store', compact('empresa'))}}"  class="needs-validation"  accept-charset="utf-8" enctype="multipart/form-data" novalidate>
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="matricula" name="matricula" value="{{old('matricula')}}" placeholder="Matrícula">
                                <div class="valid-feedback">ok!</div>
                                <div class="invalid-feedback">Inválido!</div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="departamento" name="departamento" value="{{old('departamento')}}" placeholder="Departamento">
                            <div class="valid-feedback">ok!</div>
                            <div class="invalid-feedback">Inválido!</div>
                        </div>
                        <div class="col-md-3">
